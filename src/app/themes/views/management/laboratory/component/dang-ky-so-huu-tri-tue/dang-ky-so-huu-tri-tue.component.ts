...
import { FormDangKySoHuuTriTueComponent } from './form-dang-ky-so-huu-tri-tue/form-dang-ky-so-huu-tri-tue.component';

@Component({
  selector: 'app-dang-ky-so-huu-tri-tue',
  templateUrl: './dang-ky-so-huu-tri-tue.component.html',
  styleUrls: ['./dang-ky-so-huu-tri-tue.component.scss']
})
export class DangKySoHuuTriTueComponent extends BaseLaboratoryComponent<IDangKySoHuuTriTue> implements OnInit, OnDestroy {
    ...
    private get extendQueryOptions() {
        return {
            ...
            idPhongThiNghiem: this.extendModelSearch.idPhongThiNghiem,
            ...this.queryOptions,
        };
    }
    ...
    showFormCreateOrUpdate() {
        ...
        const windowRef = this.windowService.open({
            title: this.translate.get('PTN.DKSHTT'),
            content: FormDangKySoHuuTriTueComponent,
            width: 900,
            top: 100,
    ...
    removeHandler(dataItem: IDangKySoHuuTriTue) {
        this.selectionIds = [];
