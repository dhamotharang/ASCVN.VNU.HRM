...
@Component({
    selector: 'ptn-upload',
    templateUrl: './ptn-upload.component.html',
    styleUrls: ['./ptn-upload.component.scss'],
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            multi: true,
            useExisting: forwardRef(() => PtnUploadComponent),
        },
    ],
})
export class PtnUploadComponent implements OnInit, OnChanges, ControlValueAccessor {
    ...
    ngOnInit() {
        ...
        const qs = Object.keys(params)
            ...
            .join('&');
        this.uploadUrl = `${this.config.apiServer}/api/cmd/${this.config.version}/PTN/Medias/UploadFile?${qs}`;
