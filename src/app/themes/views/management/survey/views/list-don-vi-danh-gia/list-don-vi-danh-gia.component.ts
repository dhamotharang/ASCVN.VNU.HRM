...
import { ActionEnum, ActionType, FileExtensionEnum } from '@core/constants/enum.constant';
...
@Component({
    selector: 'app-list-don-vi-danh-gia',
    templateUrl: './list-don-vi-danh-gia.component.html',
    styleUrls: ['./list-don-vi-danh-gia.component.scss'],
    animations: [fadeInOnEnterAnimation(), fadeOutOnLeaveAnimation()],
})
export class ListDonViDanhGiaComponent implements OnInit, OnDestroy {
    ...
    danhGia(dataItem, flag?: boolean) {
        const str = `${dataItem.phieuDanhGiaId}_${dataItem.nhanSuDanhGiaChiTietId}_${dataItem.dotDanhGiaChiTietId}_${3}_${
            ActionEnum.CREATE
        }`;
    ...
    viewHandler(dataItem) {
        const str = `${dataItem.phieuDanhGiaId}_${dataItem.nhanSuDanhGiaChiTietId}_${dataItem.dotDanhGiaChiTietId}_${3}_${ActionEnum.VIEW}`;
        this.router.navigate([UrlConstant.ROUTE.PKS_DANH_GIA], {
            queryParams: {
                k: encodeURIComponent(this.security.encryptKey(str)),
            },
    ...
    onChuyenDanhGia(item: IPhieuTuDanhGiaViewModel) {
        ...
        // param.manHinh = TypeManagementSurveyEnum.DON_VI_DANH_GIA;
    ...
    onPrintExcel() {
        this.fileService.exportFile(
            ...
            'DanhSachExportExcelTongHopKetQuaDanhGiaCC-VCCapDonVi'
        );
    }

    onExportExcel(type: ExportEnum) {
        switch (type) {
            case ExportEnum.ExportExcel:
                this.fileService.exportFile(
                    UrlConstant.API.PKS_TONG_HOP_PHIEU_DANH_GIA + '/ExportExcel',
                    this.exportQueryOptions,
                    'DanhSachPhieuDanhGiaCapDonVi'
                );
                break;
            case ExportEnum.ExportExcelTongHopKetQuaDanhGiaXepLoaiChatLuong:
                this.fileService.exportFile(
    ...
    private get queryOptions() {
        return {
            ...
            manHinh: TypeManagementSurveyEnum.DON_VI_DANH_GIA, // enum: 3 don vi
