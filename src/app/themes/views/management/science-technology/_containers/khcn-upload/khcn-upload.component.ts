...
@Component({
    selector: 'khcn-upload',
    templateUrl: './khcn-upload.component.html',
    styleUrls: ['./khcn-upload.component.scss']
})
export class KhcnUploadComponent implements OnInit, OnChanges, ControlValueAccessor {
