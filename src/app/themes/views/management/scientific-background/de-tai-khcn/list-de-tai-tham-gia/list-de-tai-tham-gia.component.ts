...
import { IBangSoHuuTriTue, IDeTaiKhcn } from '@themes/views/management/scientific-background/_models/scientific-background.model';
...
@Component({
    selector: 'app-list-de-tai-tham-gia',
    templateUrl: './list-de-tai-tham-gia.component.html',
    styleUrls: ['./list-de-tai-tham-gia.component.scss'],
})
export class ListDeTaiThamGiaComponent extends BaseScientificBackgroundComponent<IBangSoHuuTriTue> implements OnInit, OnDestroy {
    ...
    openForm() {
        ...
        const windowRef = this.windowService.open({
            title: 'Các đề tài KH&CN các cấp đã tham gia',
