...
@Component({
    selector: 'app-list-dao-tao-sdh-ths',
    templateUrl: './list-dao-tao-sdh-ths.component.html',
    styleUrls: ['./list-dao-tao-sdh-ths.component.scss'],
})
export class ListDaoTaoSdhThsComponent extends BaseScientificBackgroundComponent<IThamGiaDaoTaoSdh> implements OnInit, OnDestroy {
    ...
    openForm() {
        ...
        const windowRef = this.windowService.open({
            title: this.translate.get('SB.TEXT.01'),
