...
import { NotificationService, CustomTranslateService, EventBusService, EventBus } from '@core/services/common';
import { MenuQuery } from '@management-state/menu/menu.query';
import { WindowService, WindowCloseResult } from '@progress/kendo-angular-dialog';
import { IKetQuaDuKien } from '@themes/views/management/science-technology/_models/science-technology.model';
...
import { FormKetQuaDuKienComponent } from '../form-ket-qua-du-kien/form-ket-qua-du-kien.component';

@Component({
    selector: 'app-list-ket-qua-du-kien',
    templateUrl: './list-ket-qua-du-kien.component.html',
    styleUrls: ['./list-ket-qua-du-kien.component.scss']
})
export class ListKetQuaDuKienComponent extends BaseLaboratoryCatalogComponent<IKetQuaDuKien> implements OnInit, OnDestroy {
    ...
    protected showFormCreateOrUpdate() {
        ...
        const windowRef = this.windowService.open({
            title: this.translate.get('SCI.KQDK.KET_QUA_DU_KIEN'),
            content: FormKetQuaDuKienComponent,
            width: 850,
            top: 10,
     ...
     * @param dataItem
     */
    removeHandler(dataItem: IKetQuaDuKien) {
        this.selectionIds = [];
    ...
    protected loadItems() {
        if (this.id && this.id !== null) {
            this.isLoading = true;
            this.gridView$ = this.apiService.post(this.url + '/GetList', {
                ...this.queryOptions,
                idRef: this.id,
            })
                .pipe(
