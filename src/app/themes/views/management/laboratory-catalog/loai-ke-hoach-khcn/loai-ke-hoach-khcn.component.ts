...
import { FormLoaiKeHoachKhcnComponent } from './form-loai-ke-hoach-khcn/form-loai-ke-hoach-khcn.component';

@Component({
    selector: 'app-loai-ke-hoach-khcn',
    templateUrl: './loai-ke-hoach-khcn.component.html',
    styleUrls: ['./loai-ke-hoach-khcn.component.scss']
})
export class LoaiKeHoachKhcnComponent extends BaseLaboratoryCatalogComponent<ILoaiKeHoach> implements OnInit, OnDestroy {
    ...
    protected showFormCreateOrUpdate() {
        ...
        const windowRef = this.windowService.open({
            title: this.translate.get('SCI.LHTHN.SCI.LKH.LOAI_KE_HOACH'),
            content: FormLoaiKeHoachKhcnComponent,
            width: 850,
            top: 10,
    ...
    * @param dataItem
    */
    removeHandler(dataItem: ILoaiKeHoach) {
        this.selectionIds = [];
