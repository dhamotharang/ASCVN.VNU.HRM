...
export class DonViTinhComponent extends BaseLaboratoryCatalogComponent<IDonViTinh> implements OnInit, OnDestroy {
    ...
    protected showFormCreateOrUpdate() {
        ...
        const windowRef = this.windowService.open({
            title: this.translate.get('PTN.DVT.DON_VI_TINH'),
            content: FormDonViTinhComponent,
            width: 850,
            top: 10,
    ...
    removeSelectedHandler() {
        if (this.selectionIds.length > 0) {
            ...
            this.modal.confirm({
                ...
                nzOnOk: () => {
                    this.apiService
                        .delete(UrlConstant.API.DM_DON_VI_TINH, body)
    ...
    * @param dataItem
    */
    removeHandler(dataItem: IDonViTinh) {
        this.selectionIds = [];
    ...
    */
    protected loadItems() {
        this.isLoading = true;
        this.gridView$ = this.apiService.post(UrlConstant.API.DM_DON_VI_TINH + '/GetList', this.queryOptions).pipe(
            map(res => {
