...
import { FormThanhVienNgoaiKhcnComponent } from './form-thanh-vien-ngoai-khcn/form-thanh-vien-ngoai-khcn.component';

@Component({
    selector: 'app-thanh-vien-ngoai-khcn',
    templateUrl: './thanh-vien-ngoai-khcn.component.html',
    styleUrls: ['./thanh-vien-ngoai-khcn.component.scss']
})
export class ThanhVienNgoaiKhcnComponent extends BaseLaboratoryCatalogComponent<IThanhVienNgoai> implements OnInit, OnDestroy {
    ...
    * @param dataItem
    */
    removeHandler(dataItem: IThanhVienNgoai) {
        this.selectionIds = [];
