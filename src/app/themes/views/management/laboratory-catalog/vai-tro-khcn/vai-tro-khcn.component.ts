...
@Component({
    selector: 'app-vai-tro-khcn',
    templateUrl: './vai-tro-khcn.component.html',
    styleUrls: ['./vai-tro-khcn.component.scss']
})
export class VaiTroKhcnComponent extends BaseLaboratoryCatalogComponent<IVaiTroKHCN> implements OnInit, OnDestroy {
    ...
    protected showFormCreateOrUpdate() {
        ...
        const windowRef = this.windowService.open({
            title: this.translate.get('SCI.VT.VAI_TRO'),
    ...
    * @param dataItem
    */
    removeHandler(dataItem: IVaiTroKHCN) {
        this.selectionIds = [];
