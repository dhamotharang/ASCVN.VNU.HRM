...
import { ITapChiKHCN } from '../_models/ptn.model';
import { FormTapChiKhcnComponent } from './form-tap-chi-khcn/form-tap-chi-khcn.component';

@Component({
    selector: 'app-tap-chi-khcn',
    templateUrl: './tap-chi-khcn.component.html',
    styleUrls: ['./tap-chi-khcn.component.scss']
})
export class TapChiKhcnComponent extends BaseLaboratoryCatalogComponent<ITapChiKHCN> implements OnInit, OnDestroy {
    url: string = UrlConstant.API.DM_TAP_CHI_KHCN;
    constructor(
    ...
    protected showFormCreateOrUpdate() {
        ...
        const windowRef = this.windowService.open({
            title: this.translate.get('SCI.TC.TAP_CHI'),
            content: FormTapChiKhcnComponent,
            width: 850,
            top: 10,
    ...
    * @param dataItem
    */
    removeHandler(dataItem: ITapChiKHCN) {
        this.selectionIds = [];
