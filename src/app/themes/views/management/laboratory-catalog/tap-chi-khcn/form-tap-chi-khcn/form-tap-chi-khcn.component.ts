...
@Component({
    selector: 'app-form-tap-chi-khcn',
    templateUrl: './form-tap-chi-khcn.component.html',
    styleUrls: ['./form-tap-chi-khcn.component.scss']
})
export class FormTapChiKhcnComponent extends BaseLaboratoryCatalogFormComponent<IVaiTroKHCN> implements OnInit, OnDestroy {
