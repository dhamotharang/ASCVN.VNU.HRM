...
import { FormTrangThaiKhcnComponent } from './form-trang-thai-khcn/form-trang-thai-khcn.component';

@Component({
  selector: 'app-trang-thai-khcn',
  templateUrl: './trang-thai-khcn.component.html',
  styleUrls: ['./trang-thai-khcn.component.scss']
})
export class TrangThaiKhcnComponent extends BaseLaboratoryCatalogComponent<ITrangThaiKHCN> implements OnInit, OnDestroy {
    ...
    showFormCreateOrUpdate() {
        ...
        const windowRef = this.windowService.open({
            title: this.translate.get('SCI.TRANG_THAI_KHCN'),
            content: FormTrangThaiKhcnComponent,
            width: 850,
            top: 10,
    ...
    removeHandler(dataItem: ITrangThaiKHCN) {
        this.selectionIds = [];
