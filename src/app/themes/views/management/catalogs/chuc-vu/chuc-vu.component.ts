import { FormChucVuComponent } from './form-chuc-vu/form-chuc-vu.component';
import { Component, OnDestroy, OnInit } from '@angular/core';
import { ModalDeleteConfig, PageConfig } from '@core/constants/app.constant';
import { UrlConstant } from '@core/constants/url.constant';
import { ApiService } from '@core/data-services/api.service';
import { IChucVu } from '@themes/views/management/catalogs/_models/catalog.model';
...
export class ChucVuComponent extends BaseCatalogComponent<IChucVu> implements OnInit, OnDestroy {
    constructor(
    ...
    showFormCreateOrUpdate() {
        ...
        const windowRef = this.windowService.open({
            title: this.translate.get('CATALOG.CHUC_VU.TITLE'),
     ...
     * @param dataItem
     */
    removeHandler(dataItem: IChucVu) {
        this.selectionIds = [];
        this.selectionIds.push(dataItem.chucVuId);
    ...
    removeSelectedHandler() {
        if (this.selectionIds.length > 0) {
            ...
            this.modal.confirm({
                ...
                nzOkType: 'danger',
                nzOnOk: () => {
                    this.apiService.delete(UrlConstant.API.DM_CHUC_VU, body).subscribe(res => {
                        // show notification
    ...
    loadItems() {
        // super.loadItems();
        this.isLoading = true;
        this.gridView$ = this.apiService.read(UrlConstant.API.DM_CHUC_VU + '/List', this.queryOptions).pipe(
            map(res => {
