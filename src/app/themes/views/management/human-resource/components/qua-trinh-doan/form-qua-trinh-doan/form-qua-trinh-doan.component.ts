...
@Component({
    selector: 'app-form-qua-trinh-doan',
    templateUrl: './form-qua-trinh-doan.component.html',
    styleUrls: ['./form-qua-trinh-doan.component.scss'],
})
export class FormQuaTrinhDoanComponent extends BaseHumanResourceFormComponent<IQuaTrinhDoan> implements OnInit, OnDestroy {
    constructor(
    ...
    createForm() {
        this.form = this.formBuilder.group({
            ...
            idChucVuDoan: [null, Validators.required],
    ...
    onSubmit() {
        ...
        if (this.form.invalid) {
            ...
            if (this.preModel && (Object.entries(this.form.value).toString() === Object.entries(this.preModel).toString())) {
                ...
                this.apiUrl = UrlConstant.API.HRM_NS_QUA_TRINH_DOAN;
                if (this.isPersonal) {
                    this.apiUrl += '/DeXuat';
                }
                this.apiService
