...
import { FormChucDanhKhoaHocComponent } from '@themes/views/management/human-resource/components/nhan-su-chuc-danh-khoa-hoc/form-chuc-danh-khoa-hoc/form-chuc-danh-khoa-hoc.component';
...
@Component({
    selector: 'app-nhan-su-chuc-danh-khoa-hoc',
    templateUrl: './nhan-su-chuc-danh-khoa-hoc.component.html',
    styleUrls: ['./nhan-su-chuc-danh-khoa-hoc.component.scss'],
})
export class NhanSuChucDanhKhoaHocComponent extends BaseHumanResourceComponent<INhanSuChucDanhKhoaHoc> implements OnInit, OnDestroy {
    constructor(
    ...
    removeHandler(dataItem: INhanSuChucDanhKhoaHoc) {
        this.selectionIds = [];
    ...
    removeSelectedHandler() {
        if (this.selectionIds.length > 0) {
            ...
            this.modal.confirm({
                ...
                nzOnOk: () => {
                    this.apiService
                        .delete(UrlConstant.API.HRM_NS_CHUC_DANH_KHOA_HOC, body)
    ...
    onApprove(flag: boolean) {
        const body: IDuyetThongTinNhanSuModel = {
            ...
            idsNhanSuChucDanhKhoaHoc: this.selectionIds,
        };
        this.opened = true;
    ...
    protected loadItems() {
        this.loading = true;
        this.gridView$ = this.apiService.read(UrlConstant.API.HRM_NS_CHUC_DANH_KHOA_HOC, this.queryOptions).pipe(
