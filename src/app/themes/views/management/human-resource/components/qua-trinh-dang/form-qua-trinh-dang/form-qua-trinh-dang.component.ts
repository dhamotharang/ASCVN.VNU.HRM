...
@Component({
    selector: 'app-form-qua-trinh-dang',
    templateUrl: './form-qua-trinh-dang.component.html',
    styleUrls: ['./form-qua-trinh-dang.component.scss'],
})
export class FormQuaTrinhDangComponent extends BaseHumanResourceFormComponent<IQuaTrinhDang> implements OnInit, OnDestroy {
    constructor(
    ...
    createForm() {
        this.form = this.formBuilder.group({
            ...
            idChucVuDang: [null, Validators.required],
    ...
    onSubmit() {
        ...
        if (this.form.invalid) {
            ...
            if (this.preModel && (Object.entries(this.form.value).toString() === Object.entries(this.preModel).toString())) {
                ...
                this.apiUrl = UrlConstant.API.HRM_NS_QUA_TRINH_DANG;
                if (this.isPersonal) {
                    this.apiUrl += '/DeXuat';
                }
                this.apiService
