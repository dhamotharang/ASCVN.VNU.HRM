...
@Component({
    selector: 'app-quan-he-gia-dinh-ho-hang',
    templateUrl: './quan-he-gia-dinh-ho-hang.component.html',
    styleUrls: ['./quan-he-gia-dinh-ho-hang.component.scss'],
})
export class QuanHeGiaDinhHoHangComponent extends BaseHumanResourceComponent<INhanSuQuanHeGiaDinh> implements OnInit {
    isShowInfo = false;
    constructor(
    ...
    ngOnInit() {
        super.ngOnInit();
        this.isShowInfo = this.isShowTabHRM(HRM_KEY.QuanHeGiaDinhVoChong) &&
