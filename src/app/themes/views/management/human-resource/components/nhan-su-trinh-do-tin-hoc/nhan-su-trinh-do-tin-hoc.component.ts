...
import { FormTrinhDoTinHocComponent } from '@themes/views/management/human-resource/components/nhan-su-trinh-do-tin-hoc/form-trinh-do-tin-hoc/form-trinh-do-tin-hoc.component';
...
@Component({
    selector: 'app-nhan-su-trinh-do-tin-hoc',
    templateUrl: './nhan-su-trinh-do-tin-hoc.component.html',
    styleUrls: ['./nhan-su-trinh-do-tin-hoc.component.scss'],
})
export class NhanSuTrinhDoTinHocComponent extends BaseHumanResourceComponent<INhanSuTrinhDoTinHoc> implements OnInit, OnDestroy {
    constructor(
    ...
    removeSelectedHandler() {
        if (this.selectionIds.length > 0) {
            ...
            this.modal.confirm({
                ...
                nzOnOk: () => {
                    this.apiService
                        .delete(UrlConstant.API.HRM_NS_TRINH_DO_TIN_HOC, body)
    ...
    onApprove(flag: boolean) {
        const body: IDuyetThongTinNhanSuModel = {
            ...
            idsNhanSuTrinhDoTinHoc: this.selectionIds,
        };
        this.opened = true;
    ...
    protected showFormCreateOrUpdate() {
        ...
        const windowRef = this.windowService.open({
            ...
            content: FormTrinhDoTinHocComponent,
            width: 850,
            top: 100,
            autoFocusedElement: 'body',
        });
    ...
    protected loadItems() {
        this.loading = true;
        this.gridView$ = this.apiService.read(UrlConstant.API.HRM_NS_TRINH_DO_TIN_HOC, this.queryOptions).pipe(
